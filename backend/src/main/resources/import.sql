...
INSERT INTO idea(id, actual_cost_in_cents, actual_ttm, description, expected_cost_in_cents,expected_ttm, stage, submitted_at, title, updated_at, expected_profit_in_cents, actual_profit_in_cents, votes, submitted_by) VALUES (9999999999, 100000, 10, 'Test description 0', 50000, 51, 'Launched', NOW(), 'Test title 1', NOW(), 100, 50, 3, 9999999998);
INSERT INTO idea(id, actual_cost_in_cents, actual_ttm, description, expected_cost_in_cents,expected_ttm, stage, submitted_at, title, updated_at, expected_profit_in_cents, actual_profit_in_cents, votes, submitted_by) VALUES (9999999998, 100001, 11, 'Test description 1', 50001, 52, 'Launched', NOW(), 'Test title 2', NOW(), 200000, 300000, 2, 9999999998);
INSERT INTO idea(id, actual_cost_in_cents, actual_ttm, description, expected_cost_in_cents,expected_ttm, stage, submitted_at, title, updated_at, expected_profit_in_cents, actual_profit_in_cents, votes, submitted_by) VALUES (9999999997, 100002, 12, 'Test description 2', 50002, 53, 'Launched', NOW(), 'Test title 3', NOW(), 34567, 23456, 1, 9999999998);
